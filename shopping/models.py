...
class WishlistItem(models.Model):
    user = models.ForeignKey(
        AppUser, on_delete=models.CASCADE, related_name="wishlist_items"
    )
    product = models.ForeignKey(
...
class CartItem(models.Model):
    user = models.ForeignKey(
        AppUser, on_delete=models.CASCADE, related_name="cart_items"
    )
    product = models.ForeignKey(
...
#     def __str__(self):
# return f'{self.quantity} x {self.product.name} in
# {self.user.username}\'s cart'
